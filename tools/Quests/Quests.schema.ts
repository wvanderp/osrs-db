...
/**
 * All quests available in Old School RuneScape.
 * This enum is dynamically generated from RuneLite's Quest.java
 */
export const QuestEnumSchema = z.enum([
    "ANIMAL_MAGNETISM",
...
export type QuestEnum = z.infer<typeof QuestEnumSchema>;

/**
 * Schema for a single quest entry
 */
export const QuestSchema = z.object({
    id: z.number().int().describe("RuneLite quest ID used by script engine"),
    enum: z.string().describe("Enum constant name in RuneLite's Quest.java"),
    name: z.string().describe("Display name of the quest"),
}).strict();

export type Quest = z.infer<typeof QuestSchema>;

/**
 * Schema for the quests.g.json file: an array of quest entries
 */
